...
$_['entry_upload_allowed']     = 'Разрешенные для загрузки типы файлов:<br /><span class="help">Расширения файлов, разрешенных для загрузки на сервер. Разделяйте значения запятыми.</span>';
$_['entry_voucher_min']        = 'Минимальная сумма подарочного ваучера:<br/><span class="help">Минимальная сумма, на которую клиент может приобрести ваучер.</span>';
$_['entry_voucher_max']        = 'Максмимальная сумма подарочного ваучера:<br/><span class="help">Максимальная сумма, на которую клиент может приобрести ваучер.</span>';
...
$_['error_customer_group_display'] = 'Назначте группу клиентов по умолчанию, если собираетесь использовать это свойство!';
