...
class ControllerProductProduct extends Controller {
	...
	public function index() { 
		...
		$this->data['path_id'] = preg_replace('%[^0-9]+%', '', ($this->request->get['path'])); 
		...
		if ($product_info) {
			...
			if ($categories) {
			   ...
			   $this->data['category_view'] = $categories_info['category_view'];
			   //$this->data['category_view'] = "1";
			}
			...
			$this->load->model('tool/image');
                        ...
                        $manufacturer_image = $this->model_catalog_manufacturer->getManufacturer($product_info['manufacturer_id']);
						 ...
						 if($manufacturer_image){
							$this->data['manufacturers_img'] = $this->model_tool_image->resize($manufacturer_image['image'], 60, 60);
						 }else{
