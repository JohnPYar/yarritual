...
/*************************************************/
/* PAGE CACHE VERSION 1.4.2 - jay@jaygilford.com */
/*************************************************/
...
define('PAGE_COMPRESS', FALSE);		// TRUE/FALSE - IF TRUE, WILL COMPRESS CONTENT IF POSSIBLE
...
define('ADMIN_SHOW_BAR', FALSE);		// TRUE/FALSE - IF TRUE, SHOWS PAGE CACHE BAR INCLUDING TIMERS (if enabled);
...
define('OCPC_DEF_LANG', 'en');		// DEFAULT LANGUAGE CODE. CHANGE TO YOUR STORES DEFAULT LANGUAGE CODE
define('OCPC_DEF_CUR', 'usd');		// DEFAULT CURRENCY CODE. CHANGE TO YOUR STORES DEFAULT CURRENCY CODE
