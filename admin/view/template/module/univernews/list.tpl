    ...
    <div class="content categorymodul">
        ...
        <table class="list">
            ...
            <tr>
				...
				<td class="left"><?php echo $column_title; ?> (<?php echo $totalunivernews; ?>)</td>
            ...
            <?php if ($univernews) { ?>
				...
				<tr class="<?php echo $class; ?>">
					<td align="center">
						<?php if ($univernews_story['selected']) { ?>
							<input type="checkbox" name="selected[]" value="<?php echo $univernews_story['univernews_id']; ?>" checked="checked" />
						<?php } else { ?>
							<input type="checkbox" name="selected[]" value="<?php echo $univernews_story['univernews_id']; ?>" />
						<?php } ?>
					</td>
					<td class="center"><img src="<?php echo $univernews_story['image']; ?>" alt="<?php echo $univernews_story['title']; ?>" style="padding: 1px; border: 1px solid #DDD;" /></td>
					<td class="left"><?php echo $univernews_story['title']; ?></td>
					<td class="left"><?php echo $univernews_story['date_added']; ?></td>
					<td class="left"><?php echo $univernews_story['viewed']; ?></td>
					<td class="left"><?php echo $univernews_story['status']; ?></td>
					<td class="right">
						<?php foreach ($univernews_story['action'] as $action) { ?> [ <a href="<?php echo $action['href']; ?>"><?php echo $action['text']; ?></a> ] <?php } ?>
					</td>
				</tr>
				<?php } ?>
            <?php } else { ?>
