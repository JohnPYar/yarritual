...
<div class="navbar">
        ...
        <table id="module" class="all_topmenulink">
          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              ...
              <td><input type="text" name="univermenucategory_module[<?php echo $module_row; ?>][image_category_width]" value="<?php echo $module['image_category_width']; ?>" class="shortfield" >
                <input type="text" name="univermenucategory_module[<?php echo $module_row; ?>][image_category_height]" value="<?php echo $module['image_category_height']; ?>" class="shortfield">
                <?php if (isset($error_category_image[$module_row])) { ?>
                <span class="error"><?php echo $error_category_image[$module_row]; ?></span>
                <?php } ?></td>   
             
			  <td><select name="univermenucategory_module[<?php echo $module_row; ?>][layout_id]">
              ...
              <td><select name="univermenucategory_module[<?php echo $module_row; ?>][position]">
         ...
         <?php } ?>
               ...
               <td>
              <select name="univermenucategory_module[<?php echo $module_row; ?>][status]">
              ...
              <td><input type="text" name="univermenucategory_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" class="shortfield"></td>
        ...
        <table id="tab" class="all_topmenulink">
          ...
          <tbody id="tab-row<?php echo $tab_row; ?>">
            <tr>	 
			  ...
			  <td><select name="univermenucategory_tab[<?php echo $tab_row; ?>][category_id]">
			...
			$ar 	= array( 'On' => '1', 'Off' => '0'); 
			$valueq 	= $tab['subcateg']; 
            $name = 'univermenucategory_tab[' . $tab_row . '][subcateg]'; 
            $id = 'subcateg'.$tab_row;
			?>
           ...
           <br /><br /> <?php echo $item_column; ?><br />
			...
			$ar 	= array( '1' => '1', '2' => '0'); 
			$valueq 	= $tab['column']; 
            $name = 'univermenucategory_tab[' . $tab_row . '][column]'; 
            $id = 'column'.$tab_row;
			?>
			<div class="btn-group" data-toggle="buttons-radio">
				<?php foreach ($ar as $key => $value) { ?>
			 ...
			 <td><div class="image">
                  ...
                  <input type="hidden" name="univermenucategory_tab[<?php echo $tab_row; ?>][image]" value="<?php echo $tab['image']; ?>" id="image<?php echo $tab_row; ?>" >
                  <br>
			  ...
			  <td>
				<?php foreach ($languages as $language) { ?>
				  <textarea  name="univermenucategory_tab[<?php echo $tab_row; ?>][title][<?php echo $language['language_id']; ?>]" class="longfield" ><?php echo isset($tab['title'][$language['language_id']]) ? $tab['title'][$language['language_id']] : ''; ?></textarea>
  ...
  <script type="text/javascript"><!--
    ...
    function addTab() {
      ...
      html += '<tr>';
	 html += '	 <td><select name="univermenucategory_tab['+ tab_row + '][category_id]">';
	  <?php foreach ($categories as $category) { ?>
	  ...
	  html += '<input type="radio" id="subcateg' + tab_row + '-1" name="univermenucategory_tab[' + tab_row + '][subcateg]" value="1" checked="checked">On';				
	  html += '</label>';
      html += '<label for="subcateg' + tab_row + '-0"  type="button" class="btn">';
	  html += '<input type="radio" id="subcateg' + tab_row + '-0" name="univermenucategory_tab[' + tab_row + '][subcateg]" value="0">Off';				
	  html += '</label>';
	   html += '</div>';
	  ...
	  html += '<input type="radio" id="column' + tab_row + '-1" name="univermenucategory_tab[' + tab_row + '][column]" value="1" checked="checked">1';				
	  html += '</label>';
      html += '<label for="column' + tab_row + '-0"  type="button" class="btn">';
	  html += '<input type="radio" id="column' + tab_row + '-0" name="univermenucategory_tab[' + tab_row + '][column]" value="0">2';				
	  html += '</label>';
	  
	  html += '</div>';
	  html += '</td>';
	  
	  html += '<td><div class="image"><img src="<?php echo $no_image; ?>" alt="" id="thumb' + tab_row + '" /><input type="hidden" name="univermenucategory_tab[' + tab_row + '][image]" value="" id="image' + tab_row + '" ><br ><a onclick="image_upload(\'image' + tab_row + '\', \'thumb' + tab_row + '\');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$(\'#thumb' + tab_row + '\').attr(\'src\', \'<?php echo $no_image; ?>\'); $(\'#image' + tab_row + '\').attr(\'value\', \'\');"><?php   echo $text_clear; ?></a></div></td>';
	 
	 
	  html += '<td>';
	  <?php foreach ($languages as $language) { ?>
		html += '<textarea name="univermenucategory_tab[' + tab_row + '][title][<?php echo $language['language_id']; ?>]" class="longfield"></textarea>';
 ...
 <script type="text/javascript"><!--
    ...
    function addModule() {	
      ...
      html += '  <tr>';
	  html += '    <td><input type="text" name="univermenucategory_module[' + module_row + '][image_category_width]" value="360" class="shortfield"> <input type="text" name="univermenucategory_module[' + module_row + '][image_category_height]" value="100" class="shortfield"></td>';	
      html += '    <td><select name="univermenucategory_module[' + module_row + '][layout_id]">';
        <?php foreach ($layouts as $layout) { ?>
          html += '<option value="<?php echo $layout['layout_id']; ?>"><?php echo addslashes($layout['name']); ?></option>';
        <?php } ?>
      html += '    </select></td>';
      html += '    <td><select name="univermenucategory_module[' + module_row + '][position]">';
      ...
      html += '    </select></td>';
	  html += '    <td class="left"><select name="univermenucategory_module[' + module_row + '][status]">';
      html += '      <option value="1" selected="selected"><?php echo $text_enabled; ?></option>';
      html += '      <option value="0"><?php echo $text_disabled; ?></option>';
      html += '    </select></td>';
      html += '    <td><input type="text" name="univermenucategory_module[' + module_row + '][sort_order]" value="" class="shortfield"></td>';
