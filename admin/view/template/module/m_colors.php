<div class="form-horizontal th_colors">
 ...
 <div class="row-fluid">
                ...
                <li><a href="#m-buttons"><?php echo $tab_buttons_text; ?></a></li>
   ...
   <div class="span2"><?php echo $text_title_fonts; ?></div>
    ...
    <div class="span2"><?php echo $text_module_fonts; ?></div>
					<div class="span10 colorfield">
						<input type="text"  name="main_headermod" value="<?php echo $main_headermod; ?>" class="color {required:false,hash:true}" >
					</div>
	</div><hr />
    <div class="row-fluid">
     ...
     <div class="row-fluid">
       ...
       <div class="row-fluid">
         ...
         <div class="row-fluid">
					...
					<div class="span10 colorfield">
						 <input type="text"  name="header_cart_link" value="<?php echo $header_cart_link; ?>" class="color {required:false,hash:true}" >
					</div>
	              </div> <hr />         
             <div class="row-fluid">
                  ...
                  <div class="row-fluid">
                   ...
                   <div class="row-fluid">
					<div class="span2"><?php echo $banner_slider_button; ?></div>
					<div class="span10 colorfield">
						Link <input type="text"  name="product_sale" value="<?php echo $product_sale; ?>" class="color {required:false,hash:true}" >
                   ...
                   <div id="m-buttons" class="tab-pane"> 
					...
					<div class="span10 colorfield">
                        ...
                        Normal background: <input type="text"  name="button_bg_color" value="<?php echo $button_bg_color; ?>" class="color {required:false,hash:true}" >
                        Border: <input type="text"  name="button_border_color" value="<?php echo $button_border_color; ?>" class="color {required:false,hash:true}" ><br /><br />
                        ...
                        Hover background: <input type="text"  name="button_bg2_color" value="<?php echo $button_bg2_color; ?>" class="color {required:false,hash:true}" >
					...
					<div class="span10 colorfield">
						<input type="text"  name="arrow_bg_color" value="<?php echo $arrow_bg_color; ?>" class="color {required:false,hash:true}" >
                  ...
                  <div class="row-fluid">
                   ...
                   <div class="row-fluid">
					...
					<div class="span10 colorfield">
						 <input type="text"  name="other_show1_link" value="<?php echo $other_show1_link; ?>" class="color {required:false,hash:true}" >
					</div>
	              </div> <hr/>
                   ...
                   <div class="row-fluid">
					...
					<div class="span10 colorfield">
                     ...
                     <div class="row-fluid">
					<div class="span2"><b><?php echo $text_feedback; ?></b></div>
					<div class="span10 colorfield">
						Background: <input type="text"  name="feed_button_bg" value="<?php echo $feed_button_bg; ?>" class="color {required:false,hash:true}" ><br /><br />
