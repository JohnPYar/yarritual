				...
				<table class="form">
					...
					<tr>
						...
						<td>
					           ...
					           <textarea style="margin: 2px; width: 808px; height: 247px;" name="blockhtml_module[<?php echo $module_row; ?>][html][<?php echo $language['language_id']; ?>]" id="html-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>"><?php echo isset($module['html'][$language['language_id']]) ? $module['html'][$language['language_id']] : ''; ?></textarea> 
