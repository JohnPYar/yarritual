...
<a href="<?php echo $url_article; ?>" class="button"><?php echo $url_article_text; ?></a>
<a href="<?php echo $url_page; ?>" class="button"><?php echo $url_page_text; ?></a>
<a href="<?php echo $url_commentpage; ?>" class="button"><?php echo $url_commentpage_text; ?></a>
<a href="#" onclick="
		$.ajax({
...
$('input[name=\'page\']').autocomplete({
	...
	select: function(event, ui) {
		$('input[name=\'page\']').val(ui.item.label);
		$('input[name=\'page_id\']').val(ui.item.value);
