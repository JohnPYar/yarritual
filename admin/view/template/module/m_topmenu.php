<div class="form-horizontal">
     ...
     <!--General menu-->   
       ...
       <div class="span2"><h4><?php echo $text_menu_generalmenu; ?></h4></div>
					<div class="span10">
						<?php 
							$ar 	= array( 'univer' => '0', 'univer full width' => '1', 'Default' => '2' , 'Default full width' => '3');
						...
						<div class='helppopup2 disableimg'><img src="view/image/univertheme/topmenu.jpg"></div>
						</div>
					</div>
				</div><hr />
         <div class="row-fluid">
       <div class="span2"><?php echo $text_m_menucolumn; ?></div>
					<div class="span3">
                      ...
                      <div class="span2"><?php echo $text_m_image; ?></div>
                        <div class="span2"> 
						<?php 
		             	$valueq 	= $categ_image_status; $name	= 'categ_image_status'; $id = 'categ_image_status';
			           ?>
			<span class="switch">
		...
		<div class="span10">
          <?php 
			...
			<span class="switch">
              ...
              <div class="row-fluid">
		<div class="span2"><?php echo $text_topcontact; ?></div>
		<div class="span10">
          <?php 
			$valueq 	= $gen_topcontact; $name = 'gen_topcontact'; $id = 'gen_topcontact';
			?>
			<span class="switch">
				<input type="checkbox" id="<?php echo $id; ?>" name="<?php echo $name; ?>" <?php if ($valueq) { ?>checked="checked"<?php }?> value="1">
				<label for="<?php echo $id; ?>" class="switch-img"></label>
          ...
          if(isset($mattlink['Top_m_links'])){
             ...
             foreach ($languages as $langId => $lang) {
                  ...
                  if (array_key_exists($lang['language_id'], $link['namelink']))
                     ...
                     $valueq = '';
      				$name			= 'univerlink[Top_m_links][' . $linkId . '][namelink][' . $lang['language_id'] . ']';
				...
				$name			= 'univerlink[Top_m_links][' . $linkId . '][url]';
            ...
            <?php 
				...
				$name			= 'univerlink[Top_m_links][' . $linkId . '][sort]';
     ...
     <!--Custom html-->
		...
		<?php foreach ($languages as $language) { ?>
							...
							<div class="span2"><?php echo $text_top_cusomlink; ?></div>
							   <div class="span10">
                               <input placeholder="<?php echo $text_top_cusomlink; ?>" name="univermod[<?php echo $language['language_id']; ?>][topmenulink_lang]" value="<?php echo isset($mattData[$language['language_id']]['topmenulink_lang']) ? $mattData[$language['language_id']]['topmenulink_lang'] : ''; ?>" id="univermod-<?php echo $language['language_id']; ?>-topmenulink_lang" type="text" >
                                </div>
                                </div><br />
							...
							<div class="span2"><?php echo $text_top_html; ?></div>
							   <div class="span10">
                                <textarea  name="univermod[<?php echo $language['language_id']; ?>][topmenulink_custom]"  id="univermod-<?php echo $language['language_id']; ?>-topmenulink_custom"><?php echo isset($mattData[$language['language_id']]['topmenulink_custom']) ? $mattData[$language['language_id']]['topmenulink_custom'] : ''; ?></textarea>
                              </div>
                              </div>
...
function addNewlink(){
		 ...
		 html += '    <tr><td>';
         <?php foreach ($languages as $language) { ?>
		 html += '    <input class="input-medium"  placeholder="<?php echo $text_top_cusomlink; ?>" type="text" name="univerlink[Top_m_links][' + numberlink + '][namelink][<?php echo $language['language_id']; ?>]"  value="">';
		 html += '    <img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" >';
		 <?php } ?> 
		 html += '	  </td>';
		 html += '	  <td>';
         html += '	  <input class="input-medium" title="URL" placeholder="<?php echo $text_top_url; ?>" type="text" name="univerlink[Top_m_links][' + numberlink + '][url]"  value="">';
		 html += '	  </td>';
		 html += '	  <td>';
         html += '	  <input class="input-medium" title="Sort order" placeholder="<?php echo $entry_sort_order; ?>" type="text" name="univerlink[Top_m_links][' + numberlink + '][sort]"  value="">';
		 html += '	  </td>';
	     html += '	  <td>';
