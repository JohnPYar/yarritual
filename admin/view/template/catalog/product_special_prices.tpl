<form action="POST" id="popup-form" style="padding: 0 10px;">
      <style type="text/css"> 
.ui-widget input, .ui-widget select, .ui-widget textarea, .ui-widget button {font-family: "Segoe UI","Open Sans", Arial, Helvetica, sans-serif;}
...
input{width: 90%;}
    ...
    <div style="<?php echo ($t == 'discount')?'':'display:none;';?>">
            <table id="discount" class="list">
              ...
              <tbody id="discount-row<?php echo $discount_row; ?>" class="nth">
                <tr>
                  ...
                  <td class="right"><a onclick="$('#discount-row<?php echo $discount_row; ?>').remove();" class="button remove"><span><?php echo $button_remove; ?></span></a></td>
                </tr>
              </tbody>
              <?php $discount_row++; ?>
              <?php } ?>
              <tfoot>
                <tr>
                  <td colspan="6"></td>
                  <td class="right"><a onclick="addDiscount();" class="button add"><span><?php echo $ad_button; ?></span></a></td>
                </tr>
              </tfoot>
            </table>
    </div>
    <div style="<?php echo ($t == 'special')?'':'display:none;';?>">
          <table id="special" class="list">
            ...
            <tbody id="special-row<?php echo $special_row; ?>" class="nth">
              <tr>
                ...
                <td class="right"><a onclick="$('#special-row<?php echo $special_row; ?>').remove();" class="button remove"><span><?php echo $button_remove; ?></span></a></td>
              </tr>
            </tbody>
            <?php $special_row++; ?>
            <?php } ?>
            <tfoot>
              <tr>
                <td colspan="5"></td>
                <td class="right"><a onclick="addSpecial();" class="button add"><span><?php echo $ad_button; ?></span></a></td>
              </tr>
            </tfoot>
          </table>
    </div>
...
function addDiscount() {
	html  = '<tbody id="discount-row' + discount_row + '" class="nth">';
	html += '  <tr>'; 
	...
	html += '    <td class="right"><a onclick="$(\'#discount-row' + discount_row + '\').remove();" class="button remove"><span><?php echo $button_remove; ?></span></a></td>';
	html += '  </tr>';	
    html += '</tbody>';
...
function addSpecial() {
	html  = '<tbody id="special-row' + special_row + '" class="nth">';
	html += '  <tr>'; 
	...
	html += '    <td class="right"><a onclick="$(\'#special-row' + special_row + '\').remove();" class="button remove"><span><?php echo $button_remove; ?></span></a></td>';
	html += '  </tr>';
    html += '</tbody>';
