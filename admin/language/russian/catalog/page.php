...
$_['url_back_text']			 = 'Назад в группу модулей';
// Column
...
// Entry
$_['entry_commentpage_status_reg']             = 'Комментирование разрешено, только зарегистрированым пользователям';
$_['entry_commentpage_status_now']             = 'Комментарии сразу публикуются на сайте, без модерирования';
$_['entry_article']              = 'Блог';
$_['column_article']             = 'Блог';
$_['entry_name']             = 'Заголовок записи:';
$_['entry_commentpage_status']	 = 'Возможность комментировать';
