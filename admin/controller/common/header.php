...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_clear_cache'] = $this->language->get('text_clear_cache');
			...
			$this->data['clear_cache'] = HTTPS_SERVER . 'index.php?route=common/home/clearCache&token=' . $this->session->data['token'];
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['seo'] = $this->url->link('module/seopro', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['blockhtml'] = $this->url->link('module/blockhtml', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['information'] = $this->url->link('catalog/article', 'token=' . $this->session->data['token'], 'SSL');
