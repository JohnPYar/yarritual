...
<img alt="" class="imgbord" src="/img/lenu.png" style="position: relative;margin-bottom: 40px;">
  ...
  <div style="float: left;width: 280px;margin-left: 20px;"><?php echo $column_right; ?><?php echo $column_left; ?></div>
  ...
  <div class="page-list">
    ...
    <div>
      ...
      <?php if ($page['thumb']) { ?>
      <div class="image"  style="float:left; margin-right: 5px;"><a href="<?php echo $page['href']; ?>"><img src="<?php echo $page['thumb']; ?>" title="<?php echo $page['name']; ?>" alt="<?php echo $page['name']; ?>" /></a></div>
      <?php } ?>
      <div class="name"><a href="<?php echo $page['href']; ?>" style="font-size: 16px;"><?php echo $page['name']; ?></a></div>
      ...
      <div style="font-size: 11px; color: #aaa;"><?php echo $text_commentpages; ?> <?php echo $page['commentpages']; ?></div>
      <div style="font-size: 11px; color: #aaa;"><?php echo $text_viewed; ?> <?php echo $page['viewed']; ?></div>
