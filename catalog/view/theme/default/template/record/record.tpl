...
$('#button-cart').bind('click', function() {
	$.ajax({
		...
		type: 'post',
		data: $('.record-info input[type=\'text\'], .record-info input[type=\'hidden\'], .record-info input[type=\'radio\']:checked, .record-info input[type=\'checkbox\']:checked, .record-info select, .record-info textarea'),
		dataType: 'json',
