...
<body>
<div style="max-width: 1087px; margin: 0 auto; background: #fff;">
	<div id="global">
		<div class="header">
			<div class="head">
			  <span class="adress" style="
		 display: block;
		 height: 0px;
	">
				  <span style="
		...
		">Похоронный дом "ЯрРитуалСервис"</span>
			 ...
			 display: block;
		">г. Ярославль, ул. Салтыкова-Щедрина, 3</span>
				  <span style="
			 position: relative; top: -8px; left: -18px; color: #E4E4E4; text-shadow: 1px 1px 3px #000;
			 display: block;
