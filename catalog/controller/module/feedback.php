...
class ControllerModuleFeedback extends Controller {
	...
	*/
	public function index($setting) {
		...
		$this->document->addStyle('catalog/view/theme/' . $this->config->get('config_template') . '/stylesheet/feedback.css');
	...
	*/
	private function validate($settings) {
		...
		if (!isset($formsSettings[$this->request->post['form_id']]) 
			...
			$required_fields = $formsSettings[$this->request->post['form_id']];
		}
